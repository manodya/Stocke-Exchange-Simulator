 ...
 */
public class ResWSJSONMarketDepthByOrder {
    private String symbol;
    private String exchange;
    private int decimalCorrFactor;
    private int instmntType;
    private List<DepthByOrder> depthByOrderList;
    ...
    public List<DepthByOrder> getDepthByOrderList() {
        return depthByOrderList;
    }

    public void setDepthByOrderList(List<DepthByOrder> depthByOrderList) {
        this.depthByOrderList = depthByOrderList;
    }
}
